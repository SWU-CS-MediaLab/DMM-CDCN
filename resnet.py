...
class ResNet(nn.Module):
  ...
  def __init__(self, block, layers, last_conv_stride=2, last_conv_dilation=1, feature_in=3):

    self.inplanes = 64
    super(ResNet, self).__init__()
    self.conv1 = nn.Conv2d(feature_in, 64, kernel_size=7, stride=2, padding=3,
                           bias=False)
